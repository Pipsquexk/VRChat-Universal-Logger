...
namespace UniLogger.Harmony
{
    public static class Patches
    {
        ...
        private static bool NewEvent(string __0, byte __1, Il2CppSystem.Object __2, [CallerMemberName] string __state = "")
        {
        ...
        private static bool PNEvent(byte __0, object __1, RaiseEventOptions __2, SendOptions __3)
        {
            switch (__0)
            {
                case 1:
        ...
        private static bool LBCEvent(byte __0, Il2CppSystem.Object __1, RaiseEventOptions __2, SendOptions __3)
        {
            switch (__0)
            {
                case 1:
                    ...
                    MelonLogger.Msg("- - - - - - - - - - - Event 1 1st Layer - - - - - - - - - - -");
                    ...
                    MelonLogger.Msg(__2.field_Public_ReceiverGroup_0.ToString());
                    MelonLogger.Msg(__2.field_Public_Byte_0.ToString());
                    MelonLogger.Msg(__2.field_Public_Byte_1.ToString());
                    MelonLogger.Msg(__2.field_Public_EventCaching_0.ToString());
                    MelonLogger.Msg(__2.field_Public_WebFlags_0.prop_Boolean_0.ToString());
                    MelonLogger.Msg(__2.field_Public_WebFlags_0.prop_Boolean_1.ToString());
                    MelonLogger.Msg(__2.field_Public_WebFlags_0.prop_Boolean_2.ToString());
                    MelonLogger.Msg(__2.field_Public_WebFlags_0.prop_Boolean_3.ToString());
                    MelonLogger.Msg(__2.field_Public_WebFlags_0.field_Public_Byte_0.ToString());
                    MelonLogger.Msg(__2.field_Public_WebFlags_0.WasCollected.ToString());
                    ...
                    MelonLogger.Msg(__3.DeliveryMode.ToString());
                    MelonLogger.Msg(__3.Reliability.ToString());
                    MelonLogger.Msg(__3.Channel.ToString());
                    MelonLogger.Msg(__3.Encrypt.ToString());
                ...
                case 3:
                    ...
                    MelonLogger.Msg("- - - - - - - - - - - Event 3 1st Layer - - - - - - - - - - -");
                    //MelonLogger.Msg(__1.ToString());
                    //foreach (byte b in Serialization.FromIL2CPPToManaged<byte[]>(__1))
                    //{
                    //    MelonLogger.Msg(ConsoleColor.Green, b);
                ...
                case 6:
                    ...
                    MelonLogger.Msg("- - - - - - - - - - - Event 6 1st Layer - - - - - - - - - - -");
                    MelonLogger.Msg(__1.ToString());
                    //foreach (byte b in Serialization.FromIL2CPPToManaged<byte[]>(__1))
                    //{
                    //    MelonLogger.Msg(ConsoleColor.Green, b);
                ...
                case 33:
                    ...
                    MelonLogger.Msg("- - - - - - - - - - - Event 33 1st Layer - - - - - - - - - - -");
                    MelonLogger.Msg(__1.ToString());
                    MelonLogger.Msg("- - - - - - - - - RaiseEventOptions - - - - - - - - -");
                    MelonLogger.Msg(__2.field_Public_ReceiverGroup_0.ToString());
                    MelonLogger.Msg(__2.field_Public_Byte_0.ToString());
                    ...
                    MelonLogger.Msg("- - - - - - - - - - - Event 33 2nd Layer - - - - - - - - - - -");
